...
//@@@ Modifed this header file. Changed HTTP_HEAD to HTTP_HEAD_HTML (replaced 2 items, one of which was a commented out line)
//@@@ Also modifed WiFiManager.cpp file to change all variable names there as well 
//@@@ Moved connectWifi function from private to public
...
class WiFiManager
{
  public:
	...
	int           connectWifi(String ssid, String pass);  //@@@ moved here from private	
  ...
  private:
    ...
    //int           connectWifi(String ssid, String pass);  //@@@ moved to public so it can be used in the sketch
